# BATALLA NAVAL
 Es un juego tradicional de estrategia y algo de suerte, que involucra a dos jugadores (uno de ellos es la máquina).

## DESCRIPCIÓN DEL JUEGO.

 ### TABLERO:
 La dimensión de los tableros son de 10x10. Los jugadores manejan un tablero de océano y un tablero de tiro; cada uno divididos en casillas.
 ...
 #### No se podrán colocar barcos pegados, es decir, entre barco y barco hay separaciones de una o más casillas.
 ...
 dirá TOCADO si todavía quedan partes del barco (casillas) sin dañar, o HUNDIDO si con ese disparo el barco ha quedado totalmente destruida 
 ...
 a una parte de barco dirá AGUA. Si ya se ingresó la coordenada pedida, perderá un turno.
 ...
 El juego puede terminar con un ganador o en empate:
     ...
     lo que generaría un empate.

     EMPATE: 
     esto sucede cuando los dos jugadores llegan a la cantidad máxima de disparos (73) y los dos siguen con barcos sin hundir 
     en su tablero de barcos o si en la última jugada los dos destruyen todos los barcos.
 ...
 ## COMO JUGAR
    ...
    * Crear en el archivo "tab_jugador.txt" el tablero con tus barcos, siempre respetando la descripción 
    ...
    * Hecho todo esto, abrir el archivo en algun editor y correrlo. Se le abrirá la ventana de la 
